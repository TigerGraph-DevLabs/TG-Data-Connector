...
public class Engine {
    ...
    public static void entry(final String[] args) throws Throwable {
        ...
        if (!isStandAloneMode && jobId == -1) {
            ...
            throw DataXException.asDataXException(FrameworkErrorCode.CONFIG_ERROR, "The non-standalone mode must provide a valid JOBID in the URL.");
        }
