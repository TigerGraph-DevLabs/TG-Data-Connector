    ...
    private static Configuration getPluginConf(PluginType pluginType,
        ...
        if (null == pluginConf) {
            throw DataXException.asDataXException(
                    ...
                    String.format("Dataax could not find the configuration for the plug-in [%s].",
                            pluginName));
        }
    ...
    public static AbstractJobPlugin loadJobPlugin(PluginType pluginType,
        ...
        try {
            ...
            throw DataXException.asDataXException(
                    ...
                    String.format("Dataax finds the Job configuration of Plugin [%s].",
                            pluginName), e);
        }
    }
    ...
    public static AbstractTaskPlugin loadTaskPlugin(PluginType pluginType,
        ...
        try {
            ...
            throw DataXException.asDataXException(FrameworkErrorCode.RUNTIME_ERROR,
                    String.format("Dataax cannot find the Task configuration of Plugin [%s].",
                            pluginName), e);
        }
    }
    ...
    public static AbstractRunner loadPluginRunner(PluginType pluginType, String pluginName) {
        ...
        switch (pluginType) {
            ...
            default:
                throw DataXException.asDataXException(
                        FrameworkErrorCode.RUNTIME_ERROR,
                        String.format("The type of the plug-in [%s] must be [reader] or [writer]!",
                                pluginName));
        }
    }
