...
public class DateColumn extends Column {
	...
	public String asString() {
		try {
			...
			throw DataXException.asDataXException(
					...
					String.format("Date[%s]  type cannot be converted to String .", this.toString()));
		}
	}
	...
	public byte[] asBytes() {
		throw DataXException.asDataXException(
				CommonErrorCode.CONVERT_NOT_SUPPORT, "Date  type cannot be converted to Bytes .");
	}

	@Override
	public Boolean asBoolean() {
		throw DataXException.asDataXException(
				CommonErrorCode.CONVERT_NOT_SUPPORT, "Date  type cannot be converted to Boolean .");
	}

	@Override
	public Double asDouble() {
		throw DataXException.asDataXException(
				CommonErrorCode.CONVERT_NOT_SUPPORT, "Date  type cannot be converted to Double .");
	}

	@Override
	public BigInteger asBigInteger() {
		throw DataXException.asDataXException(
				CommonErrorCode.CONVERT_NOT_SUPPORT, "Date  type cannot be converted to BigInteger .");
	}

	@Override
	public BigDecimal asBigDecimal() {
		throw DataXException.asDataXException(
				CommonErrorCode.CONVERT_NOT_SUPPORT, "Date  type cannot be converted to BigDecimal .");
	}
