...
public class BoolColumn extends Column {
	...
	public Date asDate() {
		throw DataXException.asDataXException(
				CommonErrorCode.CONVERT_NOT_SUPPORT, "The Bool type cannot be converted to Date.");
	}

	@Override
	public byte[] asBytes() {
		throw DataXException.asDataXException(
				CommonErrorCode.CONVERT_NOT_SUPPORT, "Boolean  type cannot be converted to Bytes .");
	}
