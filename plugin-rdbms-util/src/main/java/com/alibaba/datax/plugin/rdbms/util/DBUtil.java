    ...
    public static String chooseJdbcUrl(final DataBaseType dataBaseType,
        ...
        if (null == jdbcUrls || jdbcUrls.isEmpty()) {
            throw DataXException.asDataXException(
                    ...
                    String.format("The configuration information for your JDBcurl is wrong because JDBcurl [%s] cannot be empty.Please check your configuration and make changes.",
        ...
        try {
            return RetryUtil.executeWithRetry(new Callable<String>() {
                ...
                public String call() throws Exception {
                    ...
                    throw new Exception("IP/Port/Database/JDBC error: Unable to connect to DataX.2) Error in username/password configuration, authentication failed.Please confirm with the DBA that the connection information for this database is correct.");
//                    throw new Exception(DBUtilErrorCode.JDBC_NULL.toString());
            ...
            throw DataXException.asDataXException(
                    ...
                    String.format("The database connection failed.Because you can't find the connectable JDBcurl from :%s based on the connection information you configured.Please check your configuration and make changes.",
    ...
    public static Connection getConnection(final DataBaseType dataBaseType,
        ...
        try {
            ...
            throw DataXException.asDataXException(
                    DBUtilErrorCode.CONN_DB_ERROR,
                    String.format("The database connection failed.Failed to get the database connection based on the connection information you configured :%s.Please check your configuration and make changes.", jdbcUrl), e);
        }
    }
        ...
        try {
            ...
            throw DataXException
                    .asDataXException(DBUtilErrorCode.GET_COLUMN_INFO_FAILED,
                            String.format("Failed to get meta information for the fields of table :%s.Please contact the DBA to check the library and table information.", tableName), e);
        } finally {
                ...
                public Boolean call() throws Exception {
                    ...
                    try {
                        ...
                        throw DataXException.asDataXException(DBUtilErrorCode.RS_ASYNC_ERROR,
                                String.format("select DATABASE_ROLE from V$DATABASE failed,Please check your jdbcUrl:%s.", url));
                    } finally {
        ...
        try {
            ...
            throw DataXException
                    .asDataXException(DBUtilErrorCode.SET_SESSION_ERROR, String
                                    .format("Session configuration error.This is because the session setup fails according to your configuration.The context information is :[%s]. Please check your configuration and make changes.", message),
                            e);
        }
            ...
            try {
                ...
                throw DataXException.asDataXException(
                        DBUtilErrorCode.SET_SESSION_ERROR, String.format(
                                "Session configuration error.This is because the session setup fails according to your configuration.The context information is :[%s]. Please check your configuration and make changes.", message), e);
            }
        }
    ...
    public static boolean asyncResultSetNext(final ResultSet resultSet, int timeout) {
        ...
        try {
            ...
            throw DataXException.asDataXException(
                    DBUtilErrorCode.RS_ASYNC_ERROR, "Failed to obtain the ResultSet asynchronously", e);
        }
    }
    ...
    public static void loadDriverClass(String pluginType, String pluginName) {
        try {
            ...
            throw DataXException.asDataXException(DBUtilErrorCode.CONF_ERROR,
                    "Error loading database driver, please make sure libs directory has driver jar and plugin.json drivers configure driver class correctly!",
                    e);
        }
    }
}
