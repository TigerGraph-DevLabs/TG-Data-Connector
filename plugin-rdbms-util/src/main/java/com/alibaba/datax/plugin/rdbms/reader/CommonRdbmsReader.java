                    ...
                    default:
                        throw DataXException
                                .asDataXException(
                                        ...
                                        String.format(
                                                "The column configuration information in your configuration file is incorrect.DataAX does not support database reading of this type of field.Field name :[%s], field name :[%s], field Java type :[%s].Try using a database function to convert it to a type supported by Datax or unsynchronize the field.",
