    ...
    public static class Task {
                    ...
                    if (record.getColumnNumber() != this.columnNumber) {
                        ...
                        throw DataXException
                                .asDataXException(
                                        ...
                                        String.format(
                                                "Error in column configuration information.Because in the task you configured, the number of fields read from the source :%s is not equal to the number of fields written to the destination table :%s.Please check your configuration and make changes.",
        ...
        protected void doBatchInsert(Connection connection, List<Record> buffer)
            ...
            try {
                ...
                LOG.warn("Rolls back the write and commits it one line at a time. Because:" + e.getMessage());
                connection.rollback();
        ...
        public PreparedStatement fillPreparedStatement(PreparedStatement preparedStatement, Record record)
                throws SQLException {
        ...
        public PreparedStatement fillPreparedStatementColumnType(PreparedStatement preparedStatement, int columnIndex, int columnSqltype, Column column) throws SQLException {
            ...
            switch (columnSqltype) {
                ...
                case Types.TIME:
                    ...
                    try {
                        ...
                        throw new SQLException(String.format(
                                "Error converting TIME type: [%s]", column));
                    }
                ...
                case Types.TIMESTAMP:
                    ...
                    try {
                        ...
                        throw new SQLException(String.format(
                                "Timestamp type conversion error: [%s]", column));
                    }
                ...
                default:
                    throw DataXException
                            .asDataXException(
                                    ...
                                    String.format(
                                            "The column configuration information in your configuration file is incorrect.Datax does not support database writing to this type of field.Name of field :[%s], type of field :[%d], Java type of field :[%s].Please change the type of the field in the table or unsynchronize the field.",
