...
public class RdbmsException extends DataXException{
    ...
    public static DataXException asConnException(DataBaseType dataBaseType,Exception e,String userName,String dbName){
        if (dataBaseType.equals(DataBaseType.MySql)){
            ...
            if (dbUtilErrorCode == DBUtilErrorCode.MYSQL_CONN_DB_ERROR && dbName !=null ){
                return DataXException.asDataXException(dbUtilErrorCode,"database name is ："+dbName+" The specific error message is："+e);
            }
            if (dbUtilErrorCode == DBUtilErrorCode.MYSQL_CONN_USERPWD_ERROR ){
                return DataXException.asDataXException(dbUtilErrorCode,"database username is ："+userName+" The specific error message is："+e);
            }
            return DataXException.asDataXException(dbUtilErrorCode," The specific error message is："+e);
        }
        ...
        return DataXException.asDataXException(DBUtilErrorCode.CONN_DB_ERROR," The specific error message is："+e);
    }
    ...
    public static DataXException asQueryException(DataBaseType dataBaseType, Exception e,String querySql,String table,String userName){
        if (dataBaseType.equals(DataBaseType.MySql)){
            ...
            if (dbUtilErrorCode == DBUtilErrorCode.MYSQL_QUERY_TABLE_NAME_ERROR && table != null){
                return DataXException.asDataXException(dbUtilErrorCode,"table is："+table+" The SQL executed is :"+querySql+" The specific error message is："+e);
            }
            if (dbUtilErrorCode == DBUtilErrorCode.MYSQL_QUERY_SELECT_PRI_ERROR && userName != null){
                return DataXException.asDataXException(dbUtilErrorCode,"username is ："+userName+" The specific error message is："+e);
            }

            return DataXException.asDataXException(dbUtilErrorCode,"The SQL executed is : "+querySql+" The specific error message is："+e);
        }
        ...
        return DataXException.asDataXException(DBUtilErrorCode.SQL_EXECUTE_FAIL, "The SQL executed is : "+querySql+" The specific error message is："+e);
    }
    ...
    public static DataXException asSqlParserException(DataBaseType dataBaseType, Exception e,String querySql){
        if (dataBaseType.equals(DataBaseType.MySql)){
            throw DataXException.asDataXException(DBUtilErrorCode.MYSQL_QUERY_SQL_PARSER_ERROR, "The SQL executed is :"+querySql+" The specific error message is：" + e);
        }
        if (dataBaseType.equals(DataBaseType.Oracle)){
            throw DataXException.asDataXException(DBUtilErrorCode.ORACLE_QUERY_SQL_PARSER_ERROR,"The SQL executed is :"+querySql+" The specific error message is：" +e);
        }
        throw DataXException.asDataXException(DBUtilErrorCode.READ_RECORD_FAIL,"The SQL executed is :"+querySql+" The specific error message is："+e);
    }

    public static DataXException asPreSQLParserException(DataBaseType dataBaseType, Exception e,String querySql){
        if (dataBaseType.equals(DataBaseType.MySql)){
            throw DataXException.asDataXException(DBUtilErrorCode.MYSQL_PRE_SQL_ERROR, "The SQL executed is :"+querySql+" The specific error message is：" + e);
        }

        if (dataBaseType.equals(DataBaseType.Oracle)){
            throw DataXException.asDataXException(DBUtilErrorCode.ORACLE_PRE_SQL_ERROR,"The SQL executed is :"+querySql+" The specific error message is：" +e);
        }
        throw DataXException.asDataXException(DBUtilErrorCode.READ_RECORD_FAIL,"The SQL executed is :"+querySql+" The specific error message is："+e);
    }
    ...
    public static DataXException asPostSQLParserException(DataBaseType dataBaseType, Exception e,String querySql){
        if (dataBaseType.equals(DataBaseType.MySql)){
            throw DataXException.asDataXException(DBUtilErrorCode.MYSQL_POST_SQL_ERROR, "The SQL executed is :"+querySql+" The specific error message is：" + e);
        }

        if (dataBaseType.equals(DataBaseType.Oracle)){
            throw DataXException.asDataXException(DBUtilErrorCode.ORACLE_POST_SQL_ERROR,"The SQL executed is :"+querySql+" The specific error message is：" +e);
        }
        throw DataXException.asDataXException(DBUtilErrorCode.READ_RECORD_FAIL,"The SQL executed is :"+querySql+" The specific error message is："+e);
    }
    ...
    public static DataXException asInsertPriException(DataBaseType dataBaseType, String userName,String jdbcUrl){
        if (dataBaseType.equals(DataBaseType.MySql)){
            throw DataXException.asDataXException(DBUtilErrorCode.MYSQL_INSERT_ERROR, "username:"+userName+" jdbcURL is："+jdbcUrl);
        }

        if (dataBaseType.equals(DataBaseType.Oracle)){
            throw DataXException.asDataXException(DBUtilErrorCode.ORACLE_INSERT_ERROR,"username:"+userName+" jdbcURL is："+jdbcUrl);
        }
        throw DataXException.asDataXException(DBUtilErrorCode.NO_INSERT_PRIVILEGE,"username:"+userName+" jdbcURL is："+jdbcUrl);
    }

    public static DataXException asDeletePriException(DataBaseType dataBaseType, String userName,String jdbcUrl){
        if (dataBaseType.equals(DataBaseType.MySql)){
            throw DataXException.asDataXException(DBUtilErrorCode.MYSQL_DELETE_ERROR, "username:"+userName+" jdbcURL is："+jdbcUrl);
        }

        if (dataBaseType.equals(DataBaseType.Oracle)){
            throw DataXException.asDataXException(DBUtilErrorCode.ORACLE_DELETE_ERROR,"username:"+userName+" jdbcURL is："+jdbcUrl);
        }
        throw DataXException.asDataXException(DBUtilErrorCode.NO_DELETE_PRIVILEGE,"username:"+userName+" jdbcURL is："+jdbcUrl);
    }

    public static DataXException asSplitPKException(DataBaseType dataBaseType, Exception e,String splitSql,String splitPkID){
        if (dataBaseType.equals(DataBaseType.MySql)){

            return DataXException.asDataXException(DBUtilErrorCode.MYSQL_SPLIT_PK_ERROR,"The configured SplitPK is: "+splitPkID+", The SQL executed is : "+splitSql+" The specific error message is："+e);
        }

        if (dataBaseType.equals(DataBaseType.Oracle)){
            return DataXException.asDataXException(DBUtilErrorCode.ORACLE_SPLIT_PK_ERROR,"The configured SplitPK is: "+splitPkID+", The SQL executed is : "+splitSql+" The specific error message is："+e);
        }
