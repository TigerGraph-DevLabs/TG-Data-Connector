    ...
    public static List<Configuration> doSplit(Configuration simplifiedConf,
        ...
        if (tableNumber != adviceNumber) {
            throw DataXException.asDataXException(DBUtilErrorCode.CONF_ERROR,
                    String.format("The column configuration information in your configuration file is incorrect.The number of tables you want to write to the destination side is :%s, but according to the system advice, the number of copies you need to shard is :%s.Please check your configuration and make changes.",
    ...
    public static String getWriteTemplate(List<String> columnHolders, List<String> valueHolders, String writeMode, DataBaseType dataBaseType, boolean forceUseUpdate) {
        ...
        if (!isWriteModeLegal) {
            throw DataXException.asDataXException(DBUtilErrorCode.ILLEGAL_VALUE,
                    String.format("The writeMode:%s error you configured.Because Datax currently only supports replace,update, or insert modes.Please check your configuration and make changes.", writeMode));
        }
        // && writeMode.trim().toLowerCase().startsWith("replace")
